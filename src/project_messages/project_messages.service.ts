...
// //   async findAll(): Promise<ProjectMessage[]> {
...
// //   async findAllByProject(projectId: number): Promise<ProjectMessage[]> {
...
// //   async findOne(id: number): Promise<ProjectMessage> {
...
//       // Renvoyer une structure simplifiée
//       const result = {
//         id: savedMessage.id,
//         content: savedMessage.content,
//         senderId: savedMessage.sender.id,
//         projectId: savedMessage.project.id,
//         created_at: savedMessage.created_at,
//       };
//       this.logger.log(
//         `Message avec structure simplifiée : ${JSON.stringify(result)}`,
//       );
...
//       projectId: updatedMessage.project.id,
